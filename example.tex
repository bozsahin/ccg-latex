...
Examples with the \verb|\cgex{n}{..}| command:\vfill
...
Another example, to show glossing in the end:\medskip

\begin{ccg}{3}{ver-dir & -t & -ti.}{
give{-caus} & {-caus} & {-past}\\
\cgf{\cgs{VP}{inf}\bs\cgs{NP}{dat}\bs\cgs{NP}{dat}\bs\cgs{NP}{acc}}
& \cgf{(S\bs\cgs{NP}{nom}\bs\cgs{NP}{case})\lds\cgs{VP}{inf}}\\
